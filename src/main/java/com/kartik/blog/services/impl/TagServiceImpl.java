...
import com.kartik.blog.repositories.TagRepository;
...
public class TagServiceImpl implements TagService {
    ...
    public List<Tag> createTags(Set<String> tagNames) {
        ...
        List<Tag> existing_tags = tagRepository.findByNameIn(tagNames);

        Set<String> existingTagNames = existing_tags.stream()
                .map(Tag::getName)
        ...
        savedTags.addAll(existing_tags);
