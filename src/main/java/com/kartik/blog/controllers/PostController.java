...
import com.kartik.blog.mappers.PostMapper;
import com.kartik.blog.services.PostService;
import com.kartik.blog.services.UserService;
...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> getDrafts(@RequestAttribute UUID userId){
        ...
        List<PostDto> postDrafts = draftPosts.stream().map(postMapper::toDto).toList();
        return ResponseEntity.ok(postDrafts);
    }
